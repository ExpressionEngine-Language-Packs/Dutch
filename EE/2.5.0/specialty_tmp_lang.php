...
'Gebruikers Notificatie van Forum Posts',
...
'Dit template bevat de instructie die een geruiker ontvangt als hij z&#39;n password vergeten is.',

'mailinglist_activation_instructions' => 
'Instructies voor het Activeren van de Mailinglijst',

'mailinglist_activation_instructions_desc' => 
'Dit template bevat de instructie voor het activeren van de mailinglijst.',
...
'Dit template bevat de instructie voor het resetten van het wachtwoord.',

'validated_member_notify' => 
'Bericht voor Lid Account Validatie',

'decline_member_validation' => 
'Bericht voor Lid Account Afwijzing ',

'validated_member_notify_desc' => 
'Dit template bevat het bericht dat leden ontvangen wanneer een administrator hun account heeft goedgekeurd.',

'use_this_template' => 
'Deze template inschakelen?',

'use_this_template_exp' => 
'Als u op nee klikt, zal deze template niet gebruikt worden. In plaats daarvan zal het bericht dynamisch gegenereerd worden in de gekozen taal van de gebruiker. ',

'user_messages_template_desc' => 
'The bedoeling van deze template is dat de error bericht en andere berichten voor gebruikers die zichtbaar worden na een bepaalde actie, zoals inloggen, een formulier invullen etc.',

'user_messages_template_warning' => 
'Verwijder de volgende 5 variabelen niet:',
...
'pm_inbox_full_desc' => 
'Deze template laat het bericht zien dat een gebruiker ontvangt als hij niet in staat is Priv&#233; Berichten te ontvangen doordat zijn Inbox vol is.',

'forum_moderation_notification' => 
'Gebruikers notificatie van Forum Thread Moderatie',

'forum_moderation_notification_desc' => 
'Deze template laat het bericht zien dat een gebruiker ontvangt als zijn forum topic is verplaatst, opgesplitst of samengevoegd door een moderator.',

'forum_report_notification' => 
'Moderator Notificatie van Forum Post Melding',

'forum_report_notification_desc' => 
'Deze template omvat de notificaties die moderators ontvangen wanneer een gebruiker een forum post meldt.',
